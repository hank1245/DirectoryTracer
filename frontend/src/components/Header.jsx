...
const Header = () => {
  useEffect(() => {
    // Load Buy Me a Coffee script with better error handling
    const loadBuyMeACoffeeScript = () => {
      ...
      script.setAttribute("data-slug", "hank1245");
      ...
      script.onload = () => {
        ...
        // Hide the HTML fallback button and show the script button
      ...
      script.onerror = () => {
        console.error(
          "Failed to load Buy Me a Coffee script, using HTML fallback"
        );
        // Keep the HTML fallback button visible
      };

      document.head.appendChild(script);
    };

    // Delay the script loading to ensure DOM is ready
